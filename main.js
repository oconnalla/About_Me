...
//username question
var userName = prompt('First, let\'s start out by getting to know you a bit better. What is your name?');
console.log('What is your name? ' + userName);
alert('Hi, ' + userName + ' that is such a cool name! Now that I know something about you, let\'s see how much you know about me!');
...
if(vegetarian === 'YES' || vegetarian === 'YA' || vegetarian === 'YUP') {
  alert('No way, I haven\'t had meat in years! Well, except one crazy weekend, but that\'s our little secret!');
  turns--;
} else if (vegetarian=== 'NO' || vegetarian=== 'NO WAY' || vegetarian=== 'NOPE') {
...
if(skrillex === 'YES' || skrillex === 'YA' || skrillex === 'YUP') {
  alert('That\'s right, what a crazy night!');
} else if (skrillex === 'NO' || skrillex === 'NO WAY' || skrillex === 'NOPE') {
...
if(anime === 'YES' || anime === 'YA' || anime === 'YUP') {
  alert('You bet I do!');
} else if (anime === 'NO' || anime === 'NO WAY' || anime === 'NOPE') {
...
if(bear === 'YES' || bear === 'YA' || bear === 'YUP') {
  alert('I did eat a bear, but not the whole thing! It was NASTY. ');
} else if (bear === 'NO' || bear === 'NO WAY' || bear === 'NOPE') {
...
while (turns > 0) {
  var colleges= prompt('Can you guess how many colleges I have attended?');
  if (colleges < 5) {
...
for (let i = 0; i < 6; i++) {
  var states = prompt('Can you guess a state I have lived in?');

  if (states !== statesLivedIn[i]) {
    alert('Sorry, I have never lived there!');
  }
  else if (states === statesLivedIn[i] ) {
    alert('that is correct! The States I have lived in are Washinton, Mississippi, Idaho, Oregon, and New York!');
    break;
  }

}
console.log('Can you guess a state I have lived in?' + states);
// console.log('Can you guess a state I have lived in?' + states)
